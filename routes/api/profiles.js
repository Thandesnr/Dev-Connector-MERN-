...
// @desc     Get the current loggged in users profile
// @access   Private  
...
// @route    DELETE api/profile/experience/:exp_ id
...
router.delete("/experience/:exp_id",auth, async (req,res) =>{
    try {
        ...
        // Getting the correct experience to remove ie Get remove index
...
router.delete("/education/:edu_id",auth, async (req,res) =>{
    try {
        ...
        // Getting the correct education to remove ie Get remove index
